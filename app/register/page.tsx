        ...
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-12">
                <div className="w-full max-w-sm mx-auto">
                    ...
                    <h1 className="text-3xl sm:text-4xl font-bold text-black">Create your account</h1>
                    <p className="text-gray-500 mt-2 text-sm sm:text-base">
                        Tham gia cộng đồng 25,000+ người yêu cây xanh của Leafy.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
                        ...
                        <label className="flex items-start gap-2 text-sm text-gray-600 cursor-pointer select-none">
                            <input
                                ...
                                className="w-4 h-4 mt-0.5 rounded border-gray-300 accent-lime-400 flex-shrink-0"
                            />
                            <span>
                                Tôi đồng ý với{" "}
                                <Link href="#" className="text-black underline underline-offset-2">
                                    Điều khoản dịch vụ
                                </Link>{" "}
                                và{" "}
                                <Link href="#" className="text-black underline underline-offset-2">
            ...
            <div className="hidden lg:block lg:w-1/2 relative">
                <img
                    src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1200&h=1600&fit=crop"
                    alt="Outdoor garden"
                ...
                <div className="absolute bottom-12 left-12 right-12 text-white">
                    <p className="text-2xl font-bold leading-snug">
                        "The 30-day health guarantee gave us the confidence to finally try raising a Fiddle Leaf Fig."
                    </p>
                    <div className="flex items-center gap-3 mt-6">
                        ...
                        />
                        <div>
                            <p className="font-semibold text-sm">Sarah & Leo</p>
                            <p className="text-xs text-white/70">Fiddle Leaf Parents</p>
                        </div>
                    </div>
                </div>
            </div>
